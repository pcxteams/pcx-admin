...
export default async function AppLayout({
  ...
  // The SETTINGS nav section (Workspace Settings / Leader Resources) should
  // be visible to a workspace Manager/Leader but not an Agent — a
  // distinction the platform role (session.user.role) can't make, since
  // Managers/Leaders/Agents all share the same platform role. Resolve their
  // actual membership role via the same endpoint the self-service Workspace
